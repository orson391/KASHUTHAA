...
@dso_cache = dso_local local_unnamed_addr global [492 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.63_name, ; name: libaot-System.Net.NameResolution.dll.so
		ptr null; void* handle (0x0)
	}, ; 14
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 2520363857116540422, ; hash 0x22fa2193182a2e06, from name: libaot-Play Kazhutha
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Play Kazhutha.dll.so
		ptr null; void* handle (0x0)
	}, ; 62
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.66_name, ; name: libaot-System.Net.Sockets.dll.so
		ptr null; void* handle (0x0)
	}, ; 89
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 3916715265949852084, ; hash 0x365af7c8614a61b4, from name: Play Kazhutha
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Play Kazhutha.dll.so
		ptr null; void* handle (0x0)
	}, ; 104
	...
	%struct.DSOCacheEntry {
		i64 7901534860913223728, ; hash 0x6da7e41785192830, from name: Play Kazhutha.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Play Kazhutha.dll.so
		ptr null; void* handle (0x0)
	}, ; 195
	...
	%struct.DSOCacheEntry {
		i64 9626824073503596204, ; hash 0x8599597d605c5eac, from name: aot-Play Kazhutha
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Play Kazhutha.dll.so
		ptr null; void* handle (0x0)
	}, ; 247
	...
	%struct.DSOCacheEntry {
		i64 11043902620496933437, ; hash 0x9943d2eb94b9b23d, from name: libaot-Play Kazhutha.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Play Kazhutha.dll.so
		ptr null; void* handle (0x0)
	}, ; 282
	...
	%struct.DSOCacheEntry {
		i64 16065264005980743290, ; hash 0xdef3487efb59e67a, from name: aot-Play Kazhutha.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Play Kazhutha.dll.so
		ptr null; void* handle (0x0)
	}, ; 430
...
@.env.3 = private unnamed_addr constant [37 x i8] c"6a0740a5-13e5-4c32-8117-fa7b71b03273\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [29 x i8] c"com.companyname.playkazhutha\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [28 x i8] c"libaot-Play Kazhutha.dll.so\00", align 16
...
@.DSOCacheEntry.63_name = private unnamed_addr constant [40 x i8] c"libaot-System.Net.NameResolution.dll.so\00", align 16
...
@.DSOCacheEntry.66_name = private unnamed_addr constant [33 x i8] c"libaot-System.Net.Sockets.dll.so\00", align 16
